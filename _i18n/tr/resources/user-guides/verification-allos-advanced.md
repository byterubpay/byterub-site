...
This section will cover getting the ByteRub signing key, making sure it is correct, and importing the key to GnuPG.
...
On Windows or Mac, go to the [hashes file on getbyterub.org]({{ site.baseurl_root }}/downloads/hashes.txt) and save the page as `hashes.txt` to your home directory.
...
On Windows or Mac, go to [getbyterub.org]({{ site.baseurl_root }}/downloads/) and download the correct file for your operating system. Save the file to your home directory. **Do not extract the files yet.**

...
#### Materiały do plików binarnych ByteRub:  [Pliki Binarne ByteRub]({{ site.baseurl }}/downloads/)
...
- Stwórz dysk rozruchowy Linux lub Windows i upewnij się, że twoje pliki binarne ByteRub znajdują się na tym samym dysku lub na drugim dysku (w przypadku Linuxa, upewnij się, że ściągnąłeś także kopie zależności, których będziesz potrzebował, np. libboost1.55 i miniupnpc).

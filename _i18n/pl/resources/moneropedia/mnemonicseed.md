...
summary: "Ciąg 13 lub 25 słów używany do tworzenia kopii zapasowej konta ByteRub, dostępny w wielu językach."
---

### Podstawy

Ciąg 13 lub 25 słów używany do tworzenia kopii zapasowej konta ByteRub, dostępny w wielu językach. Ten 25-słowny ciąg (13-słowny w przypadku MyByteRub) zawiera wszystkie informacje potrzebne do wglądu i wydawania funduszy z @konta ByteRub.
...
Przechowując 25-słowny klucz mnemoniczny w bezpiecznym miejscu, chronisz kopię zapasową swoich kluczy prywatnych, a więc także i wszystkich twoich ByteRub. Dzieląc się z kimkolwiek swoim kluczem mnemonicznym, pozwalasz na pełny dostęp do twoich środków.
...
Możesz bezpiecznie przechowywać swoje ByteRub w "zimnym" lub @papierowym-portfelu.

...
## Een ByteRub-portemonnee op een Ledger maken met de opdrachtregel (monero-wallet-cli)
...
3. Je moet de ByteRub-app voor de Ledger installeren en je systeem configureren. Instructies vind je [hier](https://github.com/LedgerHQ/blue-app-monero/blob/master/doc/user/bolos-app-monero.pdf) (met name de paragrafen 3.1.1 en 3.2.3). Zorg er verder voor dat het netwerk is ingesteld op `Mainnet`.
...
`monero-wallet-cli.exe --generate-from-device ByteRubPortemonnee --subaddress-lookahead 3:200` (Win 7 + 8)

`.\monero-wallet-cli.exe --generate-from-device ByteRubPortemonnee --subaddress-lookahead 3:200` (Win 10)
...
3. Je moet de ByteRub-app voor de Ledger installeren en je systeem configureren. Instructies vind je [hier](https://github.com/LedgerHQ/blue-app-monero/blob/master/doc/user/bolos-app-monero.pdf) (met name de paragrafen 3.1.1 en 3.2.2). Zorg er verder voor dat het netwerk is ingesteld op `Mainnet`.
...
3. Je moet de ByteRub-app voor de Ledger installeren en je systeem configureren. Instructies vind je [hier](https://github.com/LedgerHQ/blue-app-monero/blob/master/doc/user/bolos-app-monero.pdf) (met name de paragrafen 3.1.1 en 3.2.1). Zorg er verder voor dat het netwerk is ingesteld op `Mainnet`.
...
`./monero-wallet-cli --generate-from-device ByteRubPortemonnee --subaddress-lookahead 3:200`

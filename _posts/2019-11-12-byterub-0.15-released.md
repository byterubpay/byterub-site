...
The complete list of features and changes is on GitHub: [github.com/byterubpay/monero/releases/tag/v0.15.0.0](https://github.com/byterubpay/monero/releases/tag/v0.15.0.0).
...
You can also compile it from source by yourself. See the [instructions on GitHub](https://github.com/byterubpay/monero#compiling-monero-from-source)

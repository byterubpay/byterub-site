---
layout: post
title: Logs for the ByteRub Research Lab Meeting Held on 2019-07-01
...
**\<suraeNoether>** Other than that, there was a ByteRub coffee chat right after the Konferenco that sgp hosted. I'm not sure where the link was, but we had a lot of folks from the konferenco live, a huge portion of the MAGIC board of directors... it was a great conversation  
...
**\<byterubmooo>** OTOH the Random X reviews fell into place quick, so...  
...
**\<byterubmooo>** He got the X41 report, but I heard no more beyond "we got what we asked for".  
...
**\<byterubmooo>** Whoever wants to code their own already has the source.  
**\<byterubmooo>** (modulo yet another small speedup sarang wants to adD)  
**\<byterubmooo>** Is anyone really doing their own beyond mybyterub ?  
...
**\<endogenic>** byterubmooo: lots of ppl actually  
...
**\<byterubmooo>** I find that hard to believe, but I'll accept that.  
**\<suraeNoether>** byterubmooo: one of the interesting things about isthmus' talk was the statistical evidence of a whole ecology of byterub code out there that doesn't match our reference code or mybyterub either  
**\<endogenic>** i find it hard to accept lol  
**\<byterubmooo>** suraeNoether: it'll be 5 months of nothing, plus one month of looking. Instead of being one month of looking now.  
...
**\<byterubmooo>** smooth may have an opinion on that.  
...
**\<byterubmooo>** If it's not mined yet, it can't take others with it, so it seems much less annoying.  
**\<byterubmooo>** Good point. Currently the txpool is limited to... somehting like 300 MB I think. So you could make these unmineable txes with huge fees, but using an output locked for 10 years...  
**\<byterubmooo>** And it'd muscle out all other txes -> empty blocks.  
**\<gingeropolous>** hold my beer, ima go pwn the byterub network  
**\<byterubmooo>** Could be a separate txpool for those I guess.  
**\<suraeNoether>** lolol  
**\<kennonero[m]>** byterubmooo: would it be logical to split the mempool into txs that can be spent now?  
**\<byterubmooo>** I'd have to think a lot more to decide whether it's logical I think.  
...
**\<byterubmooo>** Even easier to DoS nodes then, no ?  
**\<suraeNoether>** hmmmm  
...
**\<byterubmooo>** Oh, reminds me. You or sarang said there was a "secret paper" to be presented at the ByteRub konferenco that would add another possible MLSAG replacement ?  
**\<byterubmooo>** Or was that DLSAG and I got confused?  
